  ...
  render() {
    return (
      <div className="col-sm-6 col-sm-offset-4 about__text">
        ...
        <p>I have a passion for mentoring, sharing and advancing my expertise, which lead me to become an organiser of Perth's Front End Developer meetup group, <a href="http://fenders.co" target="_blank">Fenders</a>. </p>
